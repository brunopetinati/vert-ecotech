...
const Dashboard = () => {
  ...
  console.log(carbon_1);
  console.log(carbon_2);
  ...
  return (
    <Container>
      ...
      <Chart data={data2} title={'Sequestro de Carbono na Atmosfera (ha)'} name={'month'} key_a={'hectares'} stroke_a={'#7eff00'} key_b={'estimate_ha'} stroke_b={'#054d00'}/>
